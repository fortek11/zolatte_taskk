...
class AlertDataSubmitted extends StatelessWidget {
  @override
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            CircleAvatar(
              radius: 25,
              backgroundColor: Color.fromARGB(255, 238, 230, 253),
              child: Icon(
                Icons.done_outline_rounded,
                size: 35,
                color: const Color.fromARGB(255, 59, 10, 144),
              ),
            ),
            const SizedBox(
              height: 15,
            ...
            const Padding(
              ...
              child: const Text("Details Captured",
